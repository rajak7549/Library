...
public class Librarian_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtusername.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 0), 4));

        txtpassword.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        txtpassword.setForeground(new java.awt.Color(204, 0, 0));
        txtpassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 0), 4));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String sql = "select * from librarian where username='" + txtusername.getText() + "'and password='" + txtpassword.getText() + "'";
            ...
            if (i == 1) {
                ...
                txtusername.setText("");
                txtpassword.setText("");
                Librarian_Dashboard m = new Librarian_Dashboard();
                m.setVisible(true);
